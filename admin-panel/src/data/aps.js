// IEEE Antennas & Propagation Society (APS) Data Configuration
export const apsData = {
  name: "IEEE Antennas & Propagation Society (APS)",
  motto: "Advancing Electromagnetics, Antennas, and Propagation",
  description: "Providing students with resources, simulations, and hands-on designs in microwave, electromagnetics, and wave propagation technologies.",
  about: {
  ...
  initiatives: [
    {
      ...
      description: "Hands-on sessions focusing on microstrip design, printing, etching, and network analysis measurement.",
      icon: "Layers",
      tag: "Hardware"
    },
    {
      title: "HFSS Design Workshops",
      description: "Simulation bootcamps mapping antenna parameters, radiation patterns, and return loss simulations.",
      icon: "Code",
      tag: "Simulation"
    },
    {
      title: "RF & Electromagnetics Colloquium",
      description: "Hosting regional guest talks, research webinars, and satellite telemetry prototype presentations.",
      icon: "Award",
      tag: "Events"
    }
  ],
  ...
  members: [
    { name: "Naveenkumar B.", year: "II Year", department: "Electronics and Communication Engineering", photo: "https://i.pravatar.cc/300?img=3" },
    { name: "Nithyasree G.", year: "II Year", department: "Electronics and Communication Engineering", photo: "https://i.pravatar.cc/300?img=5" },
    { name: "Balakrishnan S.", year: "II Year", department: "Computer Science and Engineering", photo: "https://i.pravatar.cc/300?img=4" },
    { name: "Bhuvaneswari R.", year: "II Year", department: "Information Technology", photo: "https://i.pravatar.cc/300?img=9" }
  ],
  gallery: [
