...
const Committees = () => {
  const opCommittees = [
    {
      icon: <Cpu size={28} style={{ color: 'var(--secondary)' }} />,
    ...
    {
      icon: <PenTool size={28} style={{ color: 'var(--secondary)' }} />,
    ...
    {
      icon: <Share2 size={28} style={{ color: 'var(--secondary)' }} />,
