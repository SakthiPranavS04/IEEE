    ...
    <div className="app-container">
      ...
      <main style={{ flexGrow: 1 }}>
        <Routes>
          ...
          <Route path="/societies/ieee-kec-sb" element={<Navigate to="/societies" replace />} />
          <Route path="/societies/kec-sps" element={<KECSPS />} />
          <Route path="/societies/kec-wie" element={<KECWIE />} />
          <Route path="/societies" element={<SocietiesPage />} />
          
          {/* Backward compatibility redirects for old About paths */}
          <Route path="/about/ieee" element={<Navigate to="/societies/ieee" replace />} />
          ...
          <Route path="/about/ieee-kec-sb" element={<Navigate to="/societies" replace />} />
